      ...
      > 
        <div class="container">
          <div class="row text-center" style="padding-top: 120px">
            <h3 class="text-white">Advertisement List </h3>
          </div>
        </div>
      </section>
          ...
          <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm">
              <span
                ...
                class="text-white px-4 py-1 end-0 {{ $add->name === 'For Sale' ?  'bg-info' : 'bg-warning' }} position-absolute"
                >{{ $add->name }}</span
              >
              <img
                src="{{ Storage::url($add->galleries()->first()->path) }}"
                height="310"
