        ...
        <div class="row mb-4">
          <div class="col-lg-6 mb-4">
            <img
              ...
              class="rounded w-100"
              src="{{ Storage::url($add->galleries()->latest()->first()->path) }}"
              alt=""
            />
          </div>
          <div class="col-lg-6">
            <div class="row">
                @foreach($add->galleries->take(4) as $gallery)
                    <div class="col-lg-6 mb-4">
                        <img
                        style="object-fit: cover"
        ...
        <div class="row">
          <div class="col-lg-8 mb-4">
            <div class="card border-0 p-4">
              ...
              <div class="d-grid grid-custom">
                  @foreach($add->features as $feature)
                        <div class="col w-100">
                        <div
                            class="d-flex align-items-center"
                            style="column-gap: 0.4rem"
          ...
          <div class="col-lg-4">
            <div class="card py-5 h-100 border-0">
              ...
              <a href="tel:{{ $add->agent->phone }}" class="w-75 p-3 text-center mx-auto btn btn-primary"
                >Get Property</a
              >
            </div>
          </div>
